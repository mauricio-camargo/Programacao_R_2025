...
**Funções** existem em todas as linguagens de programação e funcionam como um programa inteiro, podendo conter IMPUTS, OPERAÇÕES e OUTPUTS.
...
**Exercício 7**: Faça um programa que receba do usuário um valor de temperatura em graus Fahrenheit e mostre na tela o valor transformado em graus Célsius, lembrando que:
...
## <span style="font-size:30pt">**Exercícios de *if* **</span>  

**Exercício 9:** Escreva uma função que receba do usuário um valor numérico e mostre na tela se é positivo ou negativo.

**Exercício 10:** Escreva um código que leia um número inteiro (variável num) e verifique:  
- se é positivo, imprima "Número positivo"  
- se é negativo, imprima "Número negativo"  
- se for zero, imprima "Número neutro"  

**Exercício 11:** Crie uma função que receba do usuário um valor e mostre na tela se é par ou impar (use o operador %%).

## <span style="font-size:30pt">**Exercícios de *if...else* **</span>  
**Exercício 12:** Crie uma função que receba uma idade e retorne:
...
**Exercício 13:** Crie uma função que receba o peso e a altura de alguém e determine a sua situação, conforme a tabela abaixo:
