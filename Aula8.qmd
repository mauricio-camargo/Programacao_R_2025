...
## <span style="font-size:32pt">Voltando ao exercício 1</span>
1.7. Extraia as médias de salinidades para cada `local`.  
...
2.1 Abra a planilha 2 na página da disciplina. 2.1. Armazene esta planilha num objeto tipo `dataframe` chamado `dad` usando o pacote `readxl`.  
